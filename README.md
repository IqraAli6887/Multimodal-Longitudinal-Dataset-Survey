...
| ------- | -------------- | ---------- | -------------- | ---------------- | ---------------------------------- | ------- | --------------------------------------- | --------------------- | ------------ | ----------------------- | -------------------------- | --------------------------------- | ------ |
| ADNI    | Alzheimer's    | M (I,P,T)  | USA, Canada    | [1,2,3,4]        | Progression, synthetic imaging     | 55–90   | sMRI, PET, CSF, genetics, cognitive     | 6–12 mo, 2–10 yrs     | 2004–present | 800–1,100+, 4–10 visits | multi-modal, multi-center  | Missing data, scanner variability | ✅      |
