...
| OASIS   | AD, aging      | M (I,P,T)  | USA            | [Marcus et al. 2007](https://doi.org/10.1162/jocn.2007.19.9.1498), [Marcus et al. 2010](https://doi.org/10.1162/jocn.2009.21407), [OASIS‑3 preprint 2019](https://doi.org/10.1101/2019.12.13.19014902) | Brain atrophy, staging / multimodal aging & AD | 42–95   | MRI ± PET (in OASIS‑3) | 1–n visits over years | 2005–present | 416–1,400+, multiple visits (depending on subcohort) | Cross‑sectional + longitudinal MRI, PET, clinical, cognitive, biomarkers | Heterogeneous imaging types, variable follow-up across subcohorts | ✅ |
